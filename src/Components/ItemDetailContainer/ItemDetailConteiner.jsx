    ...
    const promesaProductos = new Promise((resolve, reject) => {
        setTimeout(() => {
            resolve([
                ...
                {id: 2, categoria: 'M',nombre: 'Pantalon', marca:'Narrow' , precio:2200 , stock: 5, inicial: 1 , img:'https://www.digitalsport.com.ar/files/products/61bd23352ac14-576849-500x500.jpg', detalle:'Pantalon azul fibrana con cinturon Dama'},
